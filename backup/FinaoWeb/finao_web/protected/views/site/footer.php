...
<div class="finao-shop sidebar-background left-rounded-box">
    <div class="row">
        <div class="col-lg-5 col-md-5 col-sm-6 img-responsive">
            <a href="http://finaogearqa.com/">
          <div class="col-lg-3 col-md-3 col-sm-3 padding-gear" >      <img alt="Icon-finaoshop" src="<? echo $icon_path. "icon-finao-shop.jpg";?>"/></div><div class="col-lg-7 col-md-7 col-sm-7 margin-top-12px" style="margin-left:15px">   <span class="fjallaon_regular font-black  font-18px">GEAR</span></div>
            </a>
        </div>
        <div class="col-lg-7 col-md-7 col-sm-6 margin-top-18px left-margin-10px" >
...
<div class="finao-footer sidebar-background fade-text left-rounded-box">
    <a href="index.php?r=site/aboutus">About Us</a> | <!--<a href="index.php?r=site/privacy"><a href="#" data-toggle="modal" data-target=".bs-modal-lg-privacy">Privacy Policy</a>| --> 
	<a href="#" data-toggle="modal" data-target=".bs-modal-lg">Terms &amp; Conditions</a> | <a href="http://finaogearqa.com/">FINAO Gear</a>	    
	<div class="row footer-grey-icons">
	<a href="https://www.facebook.com/FINAONation " target="_blank" style=""><div class="footer-facebook"></div> </a>
	<a href="https://twitter.com/FINAONation"  target="_blank"><div class="footer-twitter"></div> </a>
	<a href="http://www.pinterest.com/finaonation/"  target="_blank"><div class="footer-pinterest"></div> </a>
	<a href="http://instagram.com/finaonation "  target="_blank"><div class="footer-instagram"></div> </a>
	</div>
</div>

<script type="text/javascript">
    var _gaq = _gaq || [];
    _gaq.push(['_setAccount', '<? echo $google_tracking_id; ?>']);
    _gaq.push(['_setDomainName', 'finaonation.com']);
...
<div class="modal fade bs-modal-lg-privacy" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="display:none!important;" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">      
      <div class="modal-body">
        <div class="content-page">
